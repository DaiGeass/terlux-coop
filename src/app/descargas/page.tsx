        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          <div className="glass-card p-8">
            ...
            <div className="space-y-2">
              <a href={release?.downloads.windows.installer || "/descargas/TerLux.Coop_1.0.0_x64-setup.exe"} className="btn btn-primary w-full gap-2" download>
                <Download size={16} /> Descargar instalador (.exe)
              </a>
              <a href={release?.downloads.windows.msi || "/descargas/TerLux.Coop_1.0.0_x64_en-US.msi"} className="btn btn-outline w-full gap-2" download>
          ...
          <div className="glass-card p-8">
            ...
            <div className="space-y-2">
              ...
              <a href={release?.downloads.linux.appImage || "/descargas/TerLux.Coop_1.0.0_amd64.AppImage"} className="btn btn-outline w-full gap-2" download>
