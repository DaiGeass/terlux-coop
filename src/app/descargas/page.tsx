        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          <div className="glass-card p-8">
            ...
            <div className="space-y-2">
              <a href={release?.downloads.windows.installer || "/descargas/TerLux.Coop_1.0.8_x64-setup.exe"} className="btn btn-primary w-full gap-2" download>
                <Download size={16} /> {t("Descargar instalador (.exe)")}
              </a>
              <a href={release?.downloads.windows.msi || "/descargas/TerLux.Coop_1.0.8_x64_en-US.msi"} className="btn btn-outline w-full gap-2" download>
          ...
          <div className="glass-card p-8">
            ...
            <div className="space-y-2">
              <a href={release?.downloads.linux.deb || "/descargas/TerLux.Coop_1.0.8_amd64.deb"} className="btn btn-primary w-full gap-2" download>
                <Download size={16} /> {t("Paquete .deb (Debian/Ubuntu)")}
              </a>
              <a href={release?.downloads.linux.appImage || "/descargas/TerLux.Coop_1.0.8_amd64.AppImage"} className="btn btn-outline w-full gap-2" download>
                <Download size={16} /> {t("AppImage (portátil)")}
              </a>
            </div>
            <p className="text-[11px] text-muted-foreground mt-4">
              {t(".deb:")} <code className="font-mono">sudo apt install ./TerLux.Coop_1.0.8_amd64.deb</code>. {t("AppImage: dale permiso de ejecución y ábrela.")}
            </p>
          </div>
          ...
          <div className="glass-card p-8 relative overflow-hidden">
            ...
            <div className="space-y-2">
              <a href={release?.downloads.macos.dmg || "/descargas/TerLux.Coop_1.0.8_universal.dmg"} className="btn btn-primary w-full gap-2" download>
