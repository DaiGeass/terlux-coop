...
export const commerce: Record<string, string> = {
  ...
  "Entorno de pruebas (sandbox): la recarga no cobra dinero real.":
    "Test environment (sandbox): top-ups are not real charges.",
  ...
  // Claves complementarias de traducción (todas las áreas)
  "Límite": "Limit",
  "Pago con tarjeta": "Card payment",
  "Saldo de crédito disponible": "Available credit balance",
  "CVV de la tarjeta": "Card CVV",
  "Se usa solo para el cargo; no se guarda en el servidor.": "Used only for the charge; it is not stored on the server.",
  "Tienda de servicios": "Service store",
  Actualidad: "News",
  "Adjuntar": "Attach",
  "Adjuntar archivo del drive": "Attach file from drive",
  ...
  Versión: "Version",
  Volver: "Back",
  "alquiler, almacenamiento, proyectos y tareas, calendario y reuniones, nóminas, soporte técnico y panel administrativo, accesibles": "rental, storage, projects and tasks, calendar and meetings, payroll, tech support and admin panel, accessible",
  "de seguridad de tus archivos.": "of your files' security.",
  "La contraseña debe tener al menos 8 caracteres": "Password must be at least 8 characters",
  "DD/MM/YYYY": "DD/MM/YYYY",
  MXN: "Mexican Peso",
  "Almacenar o distribuir malware, software malicioso, datos robados o archivos que comprometan la seguridad.": "Storing or distributing malware, malicious software, stolen data or files that compromise security.",
  "Intentar acceder a cuentas, sistemas o datos ajenos, saltarse controles de acceso, o interferir en la operación de los servicios.": "Attempting to access third-party accounts, systems or data, bypassing access controls, or interfering with the operation of the services.",
  "Realizar ingeniería inversa, descompilar, extraer el código o imitar la aplicación de escritorio o sus interfaces.": "Reverse engineering, decompiling, extracting code or imitating the desktop application or its interfaces.",
  "(en adelante, \\": "(hereinafter, \\",
  "El servicio se ofrece \\": "The service is provided \\",
  "10. Propiedad intelectual": "10. Intellectual property",
  "11. Disponibilidad y garantías": "11. Availability and warranties",
  "12. Limitación de responsabilidad": "12. Limitation of liability",
  "14. Modificaciones": "14. Amendments",
  "Al registrar una tarjeta o usar el saldo de crédito:": "When registering a card or using credit balance:",
  "Asignado a:": "Assigned to:",
  "Color:": "Color:",
  "Completado:": "Completed:",
  "De uso:": "In use:",
  "En cola:": "Queued:",
  "Evaluado por:": "Evaluated by:",
  "Identificación:": "Identification:",
  "Iniciado:": "Started:",
  "Intentos:": "Attempts:",
  "Leyenda:": "Legend:",
  "Nombre de la carpeta:": "Folder name:",
  "Para consultas sobre estos términos, pagos o incidencias:": "For questions about these terms, payments or issues:",
  "Período:": "Period:",
  "Programado:": "Scheduled:",
  "Resultado:": "Result:",
  "Te comprometes a no utilizar la Plataforma para:": "You agree not to use the Platform to:",
  "TerLux Coop podrá sancionar, sin perjuicio de las demás medidas, cualquier incumplimiento. Las sanciones incluyen:": "TerLux Coop may sanction, without prejudice to other measures, any breach. Sanctions include:",
  "Técnicos:": "Technical:",
  "almacenamiento, proyectos y tareas, calendario y reuniones, nóminas, soporte técnico y panel administrativo, accesibles": "storage, projects and tasks, calendar and meetings, payroll, tech support and admin panel, accessible",
  "de la plataforma web y de la aplicación de escritorio. Contacto:": "of the web platform and the desktop application. Contact:",
};
